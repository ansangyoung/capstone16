...
public class MatchingActivity extends AppCompatActivity {
    ...
    private BroadcastReceiver mLocalBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(message.substring(0, 9).equals("Not match")) { //로그인에 실패하면 바로 가입을 위해 EidtProfileActivity로 이동
                in = new Intent(MatchingActivity.this, EditProfileActivity.class);
                ...
                in = new Intent(MatchingActivity.this, MainActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(StaticManager.checkIfSMHasProfile){
            ...
            Intent in = new Intent(MatchingActivity.this, MainActivity.class);
            startActivity(in);
            finish(); //로그인 하고 나면 로그인창은 닫습니다.
